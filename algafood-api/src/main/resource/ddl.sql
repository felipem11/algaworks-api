...
create table grupo_produto (grupo_id bigint not null, permissao_id bigint not null) engine=InnoDB
...
alter table grupo_produto add constraint FKpsirg3m2lsg3tae8ibsvhlk98 foreign key (permissao_id) references permissao (id)
alter table grupo_produto add constraint FKcqtun5blxt1fa0816mef75dec foreign key (grupo_id) references grupo (id)
